...
def generate_app_code(consultores, emoji, webhook_relatorio, webhook_bastao, public_url):
    app_code_lines = [
        ...
        "        'play_sound': st.session_state.play_sound, # Adicionado para persistir o estado do som",
        "    }",
        "    try:",
        ...
        "",
        "def play_sound_html():",
        '    # Fonte de som MP3 de exemplo (SoundHelix)',
        '    return """',
        '<audio autoplay="true">',
        ...
        "    st.session_state['play_sound'] = persisted_state.get('play_sound', False)", # Carrega estado do som
        "    st.session_state['gif_warning'] = persisted_state.get('gif_warning', False)", # Carrega estado do GIF
        "    ",
        ...
        "            \n",
        "            # 1. Limpa status do antigo 'Bastão' (se houver)\n",
        ...
        "            return\n",
        "        \n",
        "    # Se o responsável atual for para status de Saída, limpa o bastão para forçar a checagem no próximo rerun\n",
        ...
        "",
        "# Inicialização e carregamento do estado (garante que as chaves existam)\n",
        "init_session_state()",
        "",
        ...
        "",
        "    # LÓGICA DE AVISO SONORO E RESET (NOVA IMPLEMENTAÇÃO)",
        "    if st.session_state['play_sound']:",
        "        st.markdown(play_sound_html(), unsafe_allow_html=True)",
        "        # Reseta o estado para garantir que toque apenas uma vez (o som já tocou no navegador)",
