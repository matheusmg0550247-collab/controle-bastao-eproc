...
def generate_app_code(consultores, emoji, webhook_relatorio, webhook_bastao, public_url):
    app_code_lines = [
        ...
        "        'gif_warning': st.session_state.gif_warning,",
        "    }",
        "    try:",
        ...
        "",
        "def play_sound_html():",
        '    # Novo som de alerta curto (exemplo: sino/gongo) - Fonte externa com som curto.',
        ...
        "    st.session_state['play_sound'] = persisted_state.get('play_sound', False)",
        "    st.session_state['gif_warning'] = persisted_state.get('gif_warning', False)",
        "    ",
        ...
        "",
        "    # LÓGICA DE AVISO SONORO E RESET",
